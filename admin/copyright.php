...
<footer class="typecho-foot" role="contentinfo">
    ...
    <nav class="resource">
        ...
        <a href="https://wyz.xyz"><?php _e('支持论坛'); ?></a> &bull;
        <a href="https://github.com/shebaoting/typecho-world/issues"><?php _e('报告错误'); ?></a> &bull;
        <a href="https://typecho.world/download/"><?php _e('资源下载'); ?></a>
    </nav>
</footer>
